...
| S1-C | DeepSeek固定profile、受监管执行器、合理固定流程、评分器 | 实际云端与工具链；40开发例全量报告；方案与写入分开；费用硬上限 | [PRD v0.10](../product/JobForge_PRD_v0.10.md)/[ADR-0018](../adr/0018-deepseek-fixed-flow-and-executor.md)经PR #41接受；C1协议/时钟/RPC接缝经PR #42合并，C2受控HTTP适配实现中，正式Worker和真实云端尚未验收 |
